...
class ConsensusResult:
    ...
    # Ghost Council
    ghost_council_recommendation: Optional[str] = None
...
class GovernanceDecision:
    ...
    policy_results: dict[str, tuple[bool, Optional[str]]]
...
class GovernanceOverlay(BaseOverlay):
    ...
    def __init__(
        ...
        eligible_voters_provider: Optional[Callable[[], int]] = None
    ):
        """
    ...
    def _evaluate_policies(self, data: dict) -> dict[str, tuple[bool, Optional[str]]]:

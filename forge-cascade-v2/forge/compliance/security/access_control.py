...
class AccessControlService:
    ...
    def require_justification(
        ...
        return resource_type in sensitive_resources and self.is_privileged_user(user_id)
...
class AuthenticationService:
    ...
    def record_failed_attempt(self, user_id: str) -> None:
        ...
        self._failed_attempts[user_id] = [t for t in self._failed_attempts[user_id] if t > cutoff]

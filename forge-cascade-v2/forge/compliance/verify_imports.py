...
def main():
    ...
    results.append(
        test_import("forge.compliance.core.config", ["ComplianceConfig", "get_compliance_config"])
    )
    results.append(
        test_import(
            "forge.compliance.core.enums",
            [
                "Jurisdiction",
                "ComplianceFramework",
                "DataClassification",
    ...
    results.append(
        test_import(
            "forge.compliance.core.registry", ["ComplianceRegistry", "get_compliance_registry"]
        )
    )
    results.append(
        test_import("forge.compliance.core.engine", ["ComplianceEngine", "get_compliance_engine"])
    )
    print()
    ...
    results.append(
        test_import("forge.compliance.encryption", ["EncryptionService", "get_encryption_service"])
    )
    print()
    ...
    results.append(
        test_import(
            "forge.compliance.residency", ["DataResidencyService", "get_data_residency_service"]
        )
    )
    print()
    ...
    results.append(
        test_import("forge.compliance.privacy", ["get_dsar_processor", "get_consent_service"])
    )
    print()
    ...
    results.append(
        test_import(
            "forge.compliance.ai_governance", ["AIGovernanceService", "get_ai_governance_service"]
        )
    )
    print()
    ...
    results.append(
        test_import(
            "forge.compliance.accessibility",
    ...
    results.append(test_import("forge.compliance.api", ["compliance_router", "extended_router"]))
    print()

    # Main module
    print("Testing Main Module...")
    results.append(
        test_import("forge.compliance", ["get_compliance_engine", "get_compliance_config"])
    )
    print()
